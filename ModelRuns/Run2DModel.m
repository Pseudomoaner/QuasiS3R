...
fieldSettings.xWidth = 100; %Width of the simulated domain (in units of fieldSettings.lam)
fieldSettings.yHeight = 100; %Height of the simulated domain (in units of fieldSettings.lam)
...
fieldSettings.areaFrac = 0.02; %Fraction of the total area that should be occupied by cells.
