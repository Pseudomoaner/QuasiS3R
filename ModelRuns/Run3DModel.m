...
fieldSettings.fieldWidth = 150; %Width of the simulated domain (in units of fieldSettings.lam)
fieldSettings.fieldHeight = 150; %Height of the simulated domain (in units of fieldSettings.lam)
...
targetSimTime = 300; %Target motile simulation time
