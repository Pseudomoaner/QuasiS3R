...
fieldSettings.killType = 'lyse'; %Whether to remove cells from simulation after death ('lyse') or inactivate them, but leave their bodies ('husk')
...
cellSettings.pop1 = 't'; %Population label to specify which cells can kill each other. Here, 'toxic' (t) vs 'susceptable' (s). Cells labelled 't' will not kill other cells labelled 't'.
cellSettings.a2 = 4;
cellSettings.f2 = 1;
cellSettings.r2 = 0;
